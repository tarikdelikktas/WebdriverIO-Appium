...
const GesturesMixin = {
    ...
    async mobileClickGesture(opts = {}) {
        ...
        await /** @type {UiAutomator2Server} */ (this.uiautomator2).jwproxy.command('/appium/gestures/click', 'POST', {
    ...
    async mobileLongClickGesture(opts = {}) {
        ...
        await /** @type {UiAutomator2Server} */ (this.uiautomator2).jwproxy.command('/appium/gestures/long_click', 'POST', {
            origin: toOrigin(elementId),
            offset: toPoint(x, y),
            duration,
        });
    ...
    async mobileDoubleClickGesture(opts = {}) {
        const { elementId, x, y } = opts;
        await /** @type {UiAutomator2Server} */ (this.uiautomator2).jwproxy.command('/appium/gestures/double_click', 'POST', {
            origin: toOrigin(elementId),
            offset: toPoint(x, y),
        });
    },
    ...
    async mobileDragGesture(opts) {
        ...
        await /** @type {UiAutomator2Server} */ (this.uiautomator2).jwproxy.command('/appium/gestures/drag', 'POST', {
            origin: toOrigin(elementId),
    ...
    async mobileFlingGesture(opts) {
        ...
        return /** @type {boolean} */ (await /** @type {UiAutomator2Server} */ (this.uiautomator2).jwproxy.command('/appium/gestures/fling', 'POST', {
            origin: toOrigin(elementId),
    ...
    async mobilePinchCloseGesture(opts) {
        ...
        await /** @type {UiAutomator2Server} */ (this.uiautomator2).jwproxy.command('/appium/gestures/pinch_close', 'POST', {
            origin: toOrigin(elementId),
            area: toRect(left, top, width, height),
            percent,
            speed,
    ...
    async mobilePinchOpenGesture(opts) {
        const { elementId, left, top, width, height, percent, speed } = opts;
        await /** @type {UiAutomator2Server} */ (this.uiautomator2).jwproxy.command('/appium/gestures/pinch_open', 'POST', {
            origin: toOrigin(elementId),
            area: toRect(left, top, width, height),
            percent,
            speed,
    ...
    async mobileSwipeGesture(opts) {
        ...
        await /** @type {UiAutomator2Server} */ (this.uiautomator2).jwproxy.command('/appium/gestures/swipe', 'POST', {
            origin: toOrigin(elementId),
            area: toRect(left, top, width, height),
            direction,
            percent,
    ...
    async mobileScrollGesture(opts) {
        const { elementId, left, top, width, height, direction, percent, speed } = opts;
        return /** @type {boolean} */ (await /** @type {UiAutomator2Server} */ (this.uiautomator2).jwproxy.command('/appium/gestures/scroll', 'POST', {
            origin: toOrigin(elementId),
            area: toRect(left, top, width, height),
            direction,
            percent,
    ...
    async mobileScrollBackTo(opts) {
        ...
        await /** @type {UiAutomator2Server} */ (this.uiautomator2).jwproxy.command(`/appium/element/${support_1.util.unwrapElement(elementId)}/scroll_to/${support_1.util.unwrapElement(elementToId)}`, 'POST', {});
    },
    /**
    ...
    async mobileScroll(opts) {
        ...
        await /** @type {UiAutomator2Server} */ (this.uiautomator2).jwproxy.command('/touch/scroll', 'POST', {
