...
const ElementMixin = {
    async active() {
        return /** @type {import('@appium/types').Element} */ (await /** @type {UiAutomator2Server} */ (this.uiautomator2).jwproxy.command('/element/active', 'GET'));
    },
    async getAttribute(attribute, elementId) {
        return String(await /** @type {UiAutomator2Server} */ (this.uiautomator2).jwproxy.command(`/element/${elementId}/attribute/${attribute}`, 'GET', {}));
    },
    ...
    async getName(elementId) {
        return /** @type {string} */ (await /** @type {UiAutomator2Server} */ (this.uiautomator2).jwproxy.command(`/element/${elementId}/name`, 'GET', {}));
    },
    async getLocation(elementId) {
        return /** @type {import('@appium/types').Position} */ (await /** @type {UiAutomator2Server} */ (this.uiautomator2).jwproxy.command(`/element/${elementId}/location`, 'GET', {}));
    },
    async getSize(elementId) {
        return /** @type {import('@appium/types').Size} */ (await /** @type {UiAutomator2Server} */ (this.uiautomator2).jwproxy.command(`/element/${elementId}/size`, 'GET', {}));
    },
    async touchLongClick(element, x, y, duration) {
        let params = { element, x, y, duration };
        await /** @type {UiAutomator2Server} */ (this.uiautomator2).jwproxy.command(`/touch/longclick`, 'POST', { params });
    },
    async touchDown(element, x, y) {
        let params = { element, x, y };
        await /** @type {UiAutomator2Server} */ (this.uiautomator2).jwproxy.command(`/touch/down`, 'POST', { params });
    },
    async touchUp(element, x, y) {
        let params = { element, x, y };
        await /** @type {UiAutomator2Server} */ (this.uiautomator2).jwproxy.command(`/touch/up`, 'POST', { params });
    },
    async touchMove(element, x, y) {
        let params = { element, x, y };
        await /** @type {UiAutomator2Server} */ (this.uiautomator2).jwproxy.command(`/touch/move`, 'POST', { params });
    },
    async doSetElementValue(params) {
        await /** @type {UiAutomator2Server} */ (this.uiautomator2).jwproxy.command(`/element/${params.elementId}/value`, 'POST', params);
    },
    async setValueImmediate(keys, elementId) {
        await /** @type {UiAutomator2Server} */ (this.uiautomator2).jwproxy.command(`/element/${elementId}/value`, 'POST', {
            elementId,
    ...
    async getText(elementId) {
        return String(await /** @type {UiAutomator2Server} */ (this.uiautomator2).jwproxy.command(`/element/${elementId}/text`, 'GET', {}));
    },
    async click(element) {
        await /** @type {UiAutomator2Server} */ (this.uiautomator2).jwproxy.command(`/element/${element}/click`, 'POST', { element });
    },
    async getElementScreenshot(element) {
        return String(await /** @type {UiAutomator2Server} */ (this.uiautomator2).jwproxy.command(`/element/${element}/screenshot`, 'GET', {}));
    },
    async tap(elementId = null, x = null, y = null, count = 1) {
        ...
        for (let i = 0; i < count; i++) {
            if (support_1.util.hasValue(elementId) && !areCoordinatesDefined) {
                ...
                await /** @type {UiAutomator2Server} */ (this.uiautomator2).jwproxy.command(`/element/${elementId}/click`, 'POST');
            }
            else {
                await /** @type {UiAutomator2Server} */ (this.uiautomator2).jwproxy.command(`/appium/tap`, 'POST', {
                    x,
                    y,
    ...
    async clear(elementId) {
        await /** @type {UiAutomator2Server} */ (this.uiautomator2).jwproxy.command(`/element/${elementId}/clear`, 'POST', {
            elementId,
        });
    },
    async getElementRect(elementId) {
        ...
        return /** @type {import('@appium/types').Rect} */ (await /** @type {UiAutomator2Server} */ (this.uiautomator2).jwproxy.command(`/element/${elementId}/rect`, 'GET'));
    },
    /**
